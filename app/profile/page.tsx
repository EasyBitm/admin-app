        ...
        {mode === "login" && (
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 w-full rounded-lg bg-accent py-2.5 text-sm font-medium text-white transition-colors hover-red disabled:cursor-not-allowed disabled:opacity-50"
            >
              {loading ? (
